#!/usr/bin/env python3
"""
Comprehensive tests for the CodexLogProcessor to ensure optimizations don't break functionality.
...
from codex_logbook.core.processor import CodexLogProcessor, Interaction


class TestCodexLogProcessor(unittest.TestCase):
    """Test suite for CodexLogProcessor using actual test data"""
    
    @classmethod
    def setUpClass(cls):
        """Set up test data directory"""
        cls.test_data_dir = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), 'mock-data', '-Users-developer-dev-demo-project')
        
        # Pre-process once to get expected values for comparison
        processor = CodexLogProcessor(cls.test_data_dir)
    ...
    def test_basic_processing(self):
        ...
        processor = CodexLogProcessor(self.test_data_dir)
    ...
    def test_deduplication(self):
        ...
        processor = CodexLogProcessor(self.temp_dir)
        messages, _ = processor.process_logs()
    ...
    def test_empty_directory(self):
        ...
        processor = CodexLogProcessor(empty_dir)
        messages, statistics = processor.process_logs()
...
class TestProcessorHelpers(unittest.TestCase):
    ...
    def test_interaction_class(self):
        ...
        self.assertEqual(interaction.model, 'codex-3-sonnet')
...
class TestProcessorConsistency(unittest.TestCase):
    ...
    def test_deterministic_processing(self):
        ...
        processor1 = CodexLogProcessor(self.test_data_dir)
        messages1, stats1 = processor1.process_logs()
        
        processor2 = CodexLogProcessor(self.test_data_dir)
...
def create_baseline_results():
    ...
    test_data_dir = os.path.join(os.path.dirname(__file__), 'mock-data', '-Users-developer-dev-demo-project')
    processor = CodexLogProcessor(test_data_dir)
    messages, statistics = processor.process_logs()

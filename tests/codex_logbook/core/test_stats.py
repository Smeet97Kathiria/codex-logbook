...
from codex_logbook.core.constants import USER_INTERRUPTION_PATTERNS
...
class TestStatisticsCalculations(unittest.TestCase):
    ...
    def test_model_distribution(self):
        ...
        self.assertIn('gpt-5', models, 
                     "Should have gpt-5 in test data")
        ...
        messages = [
            {
                ...
                "interaction_model": "codex-3-opus",

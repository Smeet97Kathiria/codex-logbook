#!/usr/bin/env python3
"""
Performance tests for Codex Logbook to measure processing time
...
class TestProcessingPerformance(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.test_data_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'mock-data', '-Users-developer-dev-large-project')
    ...
    def test_large_dataset_performance(self):
        ...
        try:
            ...
            # Time the processing
            start_time = time.time()
            processor = CodexLogProcessor(temp_dir)
            messages, statistics = processor.process_logs()
            total_time = time.time() - start_time
    ...
    def test_parallel_processing_simulation(self):
        ...
        def process_project(project_dir):
            ...
            start = time.time()
            processor = CodexLogProcessor(project_dir)

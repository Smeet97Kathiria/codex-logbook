...
# Load .env.codex-logbook.dev file if it exists
# Try multiple possible locations for the env file
possible_paths = [
    Path(__file__).parent.parent / ".env.codex-logbook.dev",  # From codex_logbook/auth.py
    Path.cwd() / ".env.codex-logbook.dev",  # Current directory
    Path.cwd().parent / ".env.codex-logbook.dev",  # Parent directory
]
...
class GoogleOAuth:
    ...
    def __init__(self):
        ...
        if is_dev_mode():
            ...
            self.redirect_uri = os.getenv("GOOGLE_REDIRECT_URI_PROD", "https://codex-logbook.dev/admin/callback")
        ...
        self.sessions_file = Path.home() / ".codex-logbook" / "admin_sessions.json"

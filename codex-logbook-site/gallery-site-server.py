#!/usr/bin/env python3
"""
FastAPI server for codex-logbook.dev site with admin functionality
"""
...
# Add parent directory to path to import codex_logbook modules
sys.path.insert(0, str(Path(__file__).parent.parent))

# Load .env.codex-logbook.dev for site configuration
...
app = FastAPI(title="Codex Logbook Site")
...
if __name__ == "__main__":
    ...
    print(f"\n🚀 Codex Logbook site server starting on http://localhost:{port}")

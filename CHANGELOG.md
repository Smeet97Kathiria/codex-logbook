...
All notable changes to Codex Logbook will be documented in this file.
...
## Added
- Windows support
- Instruction for running Codex Logbook on a remote reserver
- Removed redundant logs

## [0.1.0] - 2025-07-15

### Added
- Initial release of Codex Logbook
- **Core Analytics Features**:
  ...
  - Model usage breakdown across Codex versions
  - User interaction analysis with command complexity metrics
  - Error tracking and categorization
  - Project overview page showing all Codex projects
...
- **CLI Commands**:
  - `codex-logbook init` - Start dashboard server with auto-browser opening
  - `codex-logbook config` - View and manage configuration
  - `codex-logbook clear-cache` - Clear analytics cache
  - `codex-logbook version` - Show version information
  - `codex-logbook help` - Display comprehensive help
- **Share Functionality**:
...
[0.1.0]: https://github.com/smeetkathiria/codex_logbook/releases/tag/v0.1.0
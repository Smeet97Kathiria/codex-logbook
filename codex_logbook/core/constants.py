"""
Constants used throughout the Codex Logbook application.

This module contains constants that may need to be updated if Codex's
log format changes in future versions.
"""

# User interruption message patterns
# These are the messages that appear when a user interrupts Codex during tool use
# Update these if Codex changes the format in future versions
...
# - codex_logbook/shared/templates/dashboard.html

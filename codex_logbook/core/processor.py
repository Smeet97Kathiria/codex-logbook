#!/usr/bin/env python3
"""
Codex log processor with advanced message deduplication and statistics generation.
...
class CodexLogProcessor:
    """
    Processes Codex log files to extract and deduplicate messages.
    ...
    def _merge_message_group(self, group: list[dict]) -> dict:
        ...
        Codex logs streaming responses as multiple entries. This method:

...
function updateSingleRow(row, project) {
  ...
  const hasStats = project.stats !== null && project.stats !== undefined;
  ...
  const tokenVolume = hasStats ? formatTokenVolume(stats) : '-';
  ...
  cells[8].textContent = tokenVolume;
  cells[9].innerHTML = hasStats ? 
    '<span title="Parsed stats available" aria-label="Parsed stats available" style="color: #7A6549;">●</span>' : 
    '<span title="No parsed stats available" aria-label="No parsed stats available" style="color: #999;">○</span>';
            ...
            <tr>
                <td colspan="10">
                    <div class="empty-state">
                        ...
                        <p>Start using Codex to see your analytics here.</p>
                    </div>
                </td>
            </tr>
        `;
...
// Check if user has been using Codex for more than 30 days
      ...
      datasets: [
        {
          ...
          backgroundColor: 'rgba(235, 106, 28, 0.82)',
          borderColor: 'rgba(235, 106, 28, 1)',
          borderWidth: 1
        },
        {
          label: 'Output Tokens',
          data: data.map(d => d.output || 0),
          backgroundColor: 'rgba(176, 153, 122, 0.82)',
          borderColor: 'rgba(176, 153, 122, 1)',
          borderWidth: 1
        }
      ]
    },
      ...
      datasets: [
        {
          label: 'Input Tokens',
          data: inputCosts,
          backgroundColor: '#EB6A1C',
          stack: 'cost'
        },
        {
          label: 'Output Tokens',
          data: outputCosts,
          backgroundColor: '#B0997A',
          stack: 'cost'
        },
        {
          label: 'Cache Operations',
          data: cacheCosts,
          backgroundColor: '#7A6549',
          stack: 'cost'
        }
      ]
    },

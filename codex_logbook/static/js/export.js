// Export functionality for Codex Logbook
...
const ExportModule = {
  ...
  async generatePDF(charts) {
    ...
    doc.setFontSize(24);
    doc.text('Codex Logbook Report', 105, 30, {align: 'center'});
    ...
    if (!modal) {
      ...
      modal.innerHTML = `
                <div style="
                    ...
                    padding: 2rem;
                    border-radius: 8px;
                    box-shadow: 0 4px 20px rgba(120,80,30,0.18);
                    min-width: 300px;
                ">

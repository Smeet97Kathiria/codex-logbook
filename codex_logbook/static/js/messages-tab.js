...
function displayMessages() {
  ...
  if (hasActiveFilters) {
    ...
    countHTML = `<div style="font-size: 0.9rem; color: #7A6549;"><strong>${filteredMessages.length.toLocaleString()}</strong> messages</div>`;
    ...
    countHTML = `<div style="font-size: 0.9rem; color: #7A6549;"><strong>${totalCount.toLocaleString()}</strong> messages</div>`;
  } else {

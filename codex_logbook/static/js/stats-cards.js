    ...
    const statsHTML = `
            <div class="stat-card">
                ...
                <div class="breakdown">
                    ...
                    <span>${formatNumber((overview.total_tokens?.input || 0) + (overview.total_tokens?.output || 0))} total tokens
                        <span class="tooltip-info-icon"
                              onmouseover="showTooltip('token-volume-tooltip')" 
                              onmouseout="hideTooltip('token-volume-tooltip')">ⓘ
                            <div id="token-volume-tooltip" class="tooltip-dark position-below tooltip-sm">
                                Total input and output tokens processed in this project.
                            </div>
                        </span>
                    </span>
                ...
                <h3>Project Cost
                    ...
                    <div id="total-cost-tooltip" class="tooltip-dark position-below tooltip-sm">
                        <div style="font-size: 0.85rem; line-height: 1.4;">
                            What you would've paid if you were using the Codex API directly.
                        </div>

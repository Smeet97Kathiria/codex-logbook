"""Configuration management for Codex Logbook.
...
DEFAULTS = {
    ...
    "log_level": "INFO",
    "share_base_url": "https://codex-logbook.dev",
    "share_api_url": "https://codex-logbook.dev",
    "share_enabled": True,
}
...
class Config:
    """Manages Codex Logbook configuration with layered priority."""
    ...
    def __init__(self, config_dir: Path | None = None):
        ...
        Args:
            config_dir: Directory for config files. Defaults to ~/.codex-logbook
        """
        self.config_dir = config_dir or (Path.home() / ".codex-logbook")
